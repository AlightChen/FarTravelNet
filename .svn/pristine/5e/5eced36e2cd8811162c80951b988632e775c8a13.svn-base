...
namespace Base
{
    ...
    public class GlobalSwitch
    {
        ...
        /// 项目名
        /// </summary>
        public static string ProjectName { get; } = "FarTravelNet.Api";

        /// <summary>
        /// 网站根地址
        /// </summary>
        public static string WebRootUrl { get; set; } = "http://localhost:5001";
        ...
        /// Redis配置字符串
        /// </summary>
        public static string RedisConfig { get; } = ConfigHelper.GetConnectionString("RedisConnection");
